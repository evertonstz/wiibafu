...
TRANSLATIONS    += resources/locale/english.ts resources/locale/german.ts resources/locale/french.ts resources/locale/spanish.ts resources/locale/norwegian.ts
